...
const (
	...
	DATA_NOT_FOUND                 ErrorCode = 4_001_00_00019
	...
	DATA_EXIST ErrorCode = 4_001_00_00023
)

var errorCodes = map[ErrorCode]*CommonError{
	UNKNOWN_ERROR: {
		ClientMessage: "Unknown error.",
		SystemMessage: "Something wrong happened while processing data.",
		ErrorCode:     UNKNOWN_ERROR,
	},
	DATA_INVALID: {
		ClientMessage: "Invalid Data Request",
		SystemMessage: "Some of data has invalid value.",
